...
function MessagesContent() {
  ...
  const createNewChat = async (userId: string) => {
    try {
      ...
      // If chat already exists, it might return the existing chat
            ...
            <div className="p-4 border-b">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-2 border border-gray-300 rounded-lg text-sm focus:ring-2 focus:ring-secondary-500 focus:border-transparent text-gray-900 bg-white"
                />
              </div>
            </div>
            ...
            <div className="flex-1 overflow-y-auto">
              {loading ? (
                ...
                <div className="text-center py-12 px-4">
                  ...
                  <p className="text-sm text-gray-400 mt-1">Start chatting with influencers</p>
                </div>
              ) : (
                  ...
                  {filteredChats.map((chat) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {chat.unreadCount > 0 && (
                          <span className="bg-secondary-600 text-white text-xs font-medium px-2 py-1 rounded-full">
                            {chat.unreadCount}
                          </span>
                        )}
                      </button>
                        ...
                        >
                          ...
                          >
                            ...
                            <div className={`flex items-center justify-end gap-1 mt-1 ${
                              isOwn ? 'text-secondary-200' : 'text-gray-400'
                            }`}>
                ...
                <form onSubmit={handleSendMessage} className="p-4 border-t">
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-4 py-2 border border-gray-300 rounded-full focus:ring-2 focus:ring-secondary-500 focus:border-transparent text-gray-900 bg-white"
                    />
                    <Button
                      type="submit"
                      variant="secondary"
